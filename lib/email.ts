  ...
  await resend.emails.send({
    ...
    html: `
      <div style="font-family:sans-serif;max-width:600px;margin:0 auto;color:#111">
        ...
        <p style="color:#555">If you have reference images, reply to this email with them attached.</p>
        <p style="color:#555">Track your order status at: <a href="https://sachantoine.com/commissions/${commission.id}" style="color:#000">sachantoine.com/commissions/${commission.id}</a></p>
        <p style="color:#888;font-size:13px;margin-top:32px">— Sach Antoine / Curated Creations</p>
      </div>
    `,
  })
}
  ...
  await resend.emails.send({
    ...
    html: `
      <div style="font-family:sans-serif;max-width:600px;margin:0 auto;color:#111">
        ...
        <a href="https://sachantoine.com/admin/commissions/${commission.id}" style="display:inline-block;background:#000;color:#fff;padding:10px 20px;border-radius:6px;text-decoration:none;font-size:14px">Manage in Admin</a>
      </div>
    `,
  })
}
  ...
  await resend.emails.send({
    ...
    html: `
      <div style="font-family:sans-serif;max-width:600px;margin:0 auto;color:#111">
        ...
        ${commission.quoteAmount ? `<p style="color:#555">Quote total: <strong>$${commission.quoteAmount.toFixed(2)} CAD</strong></p>` : ""}
        ${commission.shopifyDraftOrderUrl ? `<p><a href="${commission.shopifyDraftOrderUrl}" style="display:inline-block;background:#000;color:#fff;padding:10px 20px;border-radius:6px;text-decoration:none;font-size:14px">View Invoice & Pay</a></p>` : ""}
        <p style="color:#555;margin-top:20px">Track your order: <a href="https://sachantoine.com/commissions/${commission.id}" style="color:#000">sachantoine.com/commissions/${commission.id}</a></p>
        <p style="color:#888;font-size:13px;margin-top:32px">— Sach Antoine / Curated Creations</p>
      </div>
    `,
  })
